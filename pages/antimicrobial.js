...
export default function antimicrobial() {
  return (
    <div id="main">
      <Header />
      <section
      ...
      >
        <div>
          <h1 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            Antimicrobial <span className="text-emerald-300"> Resistance </span>
          </h1>
        </div>
        <div className="lg:max-w-[45%] pt-8">
          <a
            href="antimicrobial resistance.pdf"
            target="_blank"
            rel="noreferrer"
          >
            <Image
              src="/antimicrobial resistance.png"
              alt="Covid 1"
              width="765"
              height="345"
            />
