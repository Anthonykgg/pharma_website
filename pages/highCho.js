...
export default function highCho() {
  return (
    <div id="main">
      <Header />
      <section
      ...
      >
        <div>
          <h1 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            <span className="text-emerald-300"> High </span> Cholesterol
          </h1>
        </div>
        <div className="lg:max-w-[45%] pt-8">
          <a href="High Cholesterol.pdf" target="_blank" rel="noreferrer">
            <Image
              src="/highCholesterol.png"
              alt="Covid 1"
              width="765"
              height="345"
            />
