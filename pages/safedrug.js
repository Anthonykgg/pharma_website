...
export default function safedrug() {
  return (
    <div id="main">
      <Header />
      <section
      ...
      >
        <div>
          <h1 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            Safe <span className="text-emerald-300"> Drug </span>{" "}
            Storage/Disposal
          </h1>
        </div>
        <div className="lg:max-w-[45%] pt-8">
          <a href="Safe Drug Disposal.pdf" target="_blank" rel="noreferrer">
            <Image src="/safeDrug.png" alt="Covid 1" width="765" height="345" />
          </a>
